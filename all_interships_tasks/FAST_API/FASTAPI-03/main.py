...
app = FastAPI(title="Products API - Assignment 3 Day 4")
...
# In-memory "database" – same shape as used in the assignment handout
products: List[dict] = [
    {
        "id": 1,
        "name": "Wireless Mouse",
...
@app.get("/")
def root():
    return {"message": "FastAPI Assignment 3 - Day 4"}
...
def bulk_discount(
    ...
    discount_percent: int = Query(
        ..., ge=1, le=99, description="% off to apply to the category"
    ),
):
    updated: List[dict] = []
